...
public abstract class Tree {
    ...
    public static final int TOCOMP = IM + 1;

    /**
     * unary operator for null reference checks, only used internally.
     */
    public static final int NULLCHK = TOCOMP + 1;
    ...
    public static final int DEFAULTEXPR = SUPEREXPR + 1;
    public static final int ACASEEXPR = DEFAULTEXPR + 1;
    public static final int CASESEXPR = ACASEEXPR + 1;
    public static final int ADOSTMT = CASESEXPR + 1;
    public static final int DOSSTMT = ADOSTMT + 1;
    public static final int READINTEXPR = DOSSTMT + 1;
    ...
    public static final int DCOPYEXPR = PRINTCOMP + 1;
...
public static class ADoStmt extends Tree {
    	
    	public Expr expr;
    	public Tree stmt;

        public ADoStmt(Expr expr, Tree stmt, Location loc) {
            super(ADOSTMT, loc);
    		this.expr = expr;
    		this.stmt = stmt;
        }
	...
	public static class DosStmt extends Tree {
    	
    	public List<ADoStmt> dolist;

        public DosStmt(List<ADoStmt> dolist1, ADoStmt ado2, Location loc) {
            super(DOSSTMT, loc);
    		dolist = dolist1;
    		dolist.add(ado2);
        }
    ...
    public static class CasesExpr extends Expr {

    	public Expr expr;
    	public List<ACaseExpr> cases;
    	public DefaultExpr dexpr;
    	
    	public CasesExpr(Expr expr, List<ACaseExpr> cases, DefaultExpr dexpr, Location loc) {
    		super(CASESEXPR, loc);
    		this.expr = expr;
    		this.cases = cases;
    		this.dexpr = dexpr;
    ...
    public static abstract class Visitor {
        ...
        public void visitADoStmt(ADoStmt that) {
            visitTree(that);
        }
        
        public void visitDosStmt(DosStmt that) {
            visitTree(that);
        }
